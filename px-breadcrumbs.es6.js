(function() {
  Polymer({
    ...
    _normalizePathClickTarget(evt) {
      return (evt.target._iconsetName === 'fa') ? evt.target.parentNode : evt.target;
    },
    ...
    _onPathTap(evt) {
      ...
      */
      ...
      dropdown.style.top = (targetBottom + 4) + 'px';
      dropdown.style.left = targetLeft + 'px';
      console.log('dropdown.style.top = ' + dropdown.style.top + ' dropdown.style.left = ' +dropdown.style.left);

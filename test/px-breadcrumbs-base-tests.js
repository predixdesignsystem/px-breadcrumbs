...
function runBaseTests() {
  px_breadcrumbs_1 = document.getElementById('px_breadcrumbs_1');

  suite('Base Automation Tests for px-breadcrumbs', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-breadcrumbs fixture is created', function() {
      assert.isTrue(document.getElementById('px_breadcrumbs_1') !== null);
    });
